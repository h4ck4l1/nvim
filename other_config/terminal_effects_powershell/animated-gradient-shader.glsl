...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    float speed = 0.5;
    float gradientFactor = (uv.x + uv.y) / 3.0;
	...
	vec3 color1 = vec3(0.0, 0.0, 0.0);   // Deepest midnight
    vec3 color2 = vec3(0.0, 0.0, 0.0); // Dark slate/gray-blue
    vec3 color3 = vec3(0.01, 0.01, 0.02); // Shadowy blue-black
